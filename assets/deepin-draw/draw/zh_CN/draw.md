...
当前版画板主界面由左侧竖向工具栏、顶部属性栏和标签页区域组成：左侧竖向工具栏放置选择、导入图片、形状、直线、文本、画笔、橡皮擦、模糊、裁剪等工具；顶部属性栏随当前工具显示对应参数；标签页区域用于在多个画布之间切换。
...
> ![notes](../common/notes.svg)说明：本轮已用当前版画板实际导出 PNG 图片并确认文件真实落盘，导出格式、质量、百分比/像素、保持宽高比和尺寸等参数均可在对话框中进行设置。
