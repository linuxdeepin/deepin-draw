...
2. Select the picture to be imported and click **Open**.
   ...
   If the dimensions of the picture imported exceeds those of the canvas, there will be a popup for you to choose the proper display manner.
...
2. Set the following parameters including file name, path, format, picture quality and dimensions. You can set the dimensions by percentage to scale up or down the image equally or by pixels to scaled it up or down according to the absolute pixels of the custom height and width.
...
![1|shape](fig/d_shape2.png)

![1|shape](fig/d_shape3.png)
