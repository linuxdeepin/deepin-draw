...
class DRAWLIB_EXPORT SceneCutItem : public PageItem
{
...
public:
    ...
    explicit SceneCutItem(PageItem *parent = nullptr);
    explicit SceneCutItem(const QRectF &rect, PageItem *parent = nullptr);
    ~SceneCutItem()  override;
