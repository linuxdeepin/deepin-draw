...
class PageContext;
class DRAWLIB_EXPORT FileHander: public QObject
{
    Q_OBJECT
public:
    ...
    static bool isFileLoadable(const QString &file);
    ...
    int  getDdfVersion(const QString &file) const;
