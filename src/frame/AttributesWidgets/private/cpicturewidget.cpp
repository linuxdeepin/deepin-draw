...
void CPictureWidget::initUI()
{
    ...
    drawApp->setWidgetAccesibleName(m_leftRotateBtn, "PicLeftRotateBtn");
    ...
    drawApp->setWidgetAccesibleName(m_rightRotateBtn, "PicRightRotateBtn");
    ...
    drawApp->setWidgetAccesibleName(m_flipHBtn, "PicFlipHBtn");
    ...
    drawApp->setWidgetAccesibleName(m_flipVBtn, "PicFlipVBtn");
    ...
    drawApp->setWidgetAccesibleName(m_flipAdjustment, "PicFlipAdjustmentBtn");
