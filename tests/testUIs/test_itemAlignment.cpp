...
TEST(ItemAlignment, TestMutilItemAlignment)
{
    ...
    e.addKeyRelease(Qt::Key_C, Qt::ControlModifier, 100);
    e.addKeyRelease(Qt::Key_V, Qt::ControlModifier, 100);
    e.addKeyPress(Qt::Key_A, Qt::ControlModifier, 100);
    e.addKeyRelease(Qt::Key_A, Qt::ControlModifier, 100);
    ...
    QTest::qWait(2000);
    e.clear();
    e.addKeyPress(Qt::Key_Escape, Qt::NoModifier, 100);
    e.addKeyRelease(Qt::Key_Escape, Qt::NoModifier, 100);
