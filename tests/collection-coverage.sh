...
lcov --remove ./coverageResult/deepin-draw-test_Coverage.info '*/deepin-draw_autogen/*' '*/deepin-draw-test_autogen/*' '*/usr/include/*' '*/tests/*' '*/googletest/*' '*/gtest/*' -o ./coverageResult/deepin-draw-test_Coverage.info
echo \ ===================\ do\ filter\ end\ ====================\ 
