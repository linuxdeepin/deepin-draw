...
#if TEST_CPOLYGONALSTARTOOL_ITEM
...
static CPolygonalStarTool *createPolygonalStarTool()
{
    CPolygonalStarTool *tool = new CPolygonalStarTool();
...
TEST(CPolygonalStarToolToolCreatItemUpdate, NullPInfo_NoCrash)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
    CPolygonalStarTool *tool = createPolygonalStarTool();
...
TEST(CPolygonalStarToolToolCreatItemUpdate, WrongBusinessItemType_NoCrash)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonalStarToolToolCreatItemUpdate, NoModifiers_FreeFormRect)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
    ...
    CGraphicsPolygonalStarItem *item = new CGraphicsPolygonalStarItem(5, 50, QRectF(0, 0, 1, 1));
    scene->addItem(item);
...
TEST(CPolygonalStarToolToolCreatItemUpdate, ShiftOnly_AbsLengthGeHPositive)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonalStarToolToolCreatItemUpdate, ShiftOnly_AbsLengthGeHNegative)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonalStarToolToolCreatItemUpdate, ShiftOnly_AbsLengthLtWPositive)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonalStarToolToolCreatItemUpdate, ShiftOnly_AbsLengthLtWNegative)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonalStarToolToolCreatItemUpdate, AltOnly_CenteredRect)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonalStarToolToolCreatItemUpdate, ShiftAlt_CenteredSquare)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
#endif // TEST_CPOLYGONALSTARTOOL_ITEM
