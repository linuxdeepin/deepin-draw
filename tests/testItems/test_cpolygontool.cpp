...
static CPolygonTool *createPolygonTool()
{
    CPolygonTool *tool = new CPolygonTool();
...
TEST(CPolygonToolToolCreatItemUpdate, NullPInfo_NoCrash)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
    CPolygonTool *tool = createPolygonTool();
...
TEST(CPolygonToolToolCreatItemUpdate, WrongBusinessItemType_NoCrash)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonToolToolCreatItemUpdate, NoModifiers_FreeFormRect)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
    ...
    CGraphicsPolygonItem *item = new CGraphicsPolygonItem(5, QRectF(0, 0, 1, 1));
    scene->addItem(item);
...
TEST(CPolygonToolToolCreatItemUpdate, ShiftOnly_AbsLengthGeHPositive)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonToolToolCreatItemUpdate, ShiftOnly_AbsLengthGeHNegative)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonToolToolCreatItemUpdate, ShiftOnly_AbsLengthLtWPositive)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonToolToolCreatItemUpdate, ShiftOnly_AbsLengthLtWNegative)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonToolToolCreatItemUpdate, AltOnly_CenteredRect)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CPolygonToolToolCreatItemUpdate, ShiftAlt_CenteredSquare)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
