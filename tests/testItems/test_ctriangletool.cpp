...
static CTriangleTool *createTriangleTool()
{
    CTriangleTool *tool = new CTriangleTool();
...
TEST(CTriangleToolToolCreatItemUpdate, NullPInfo_NoCrash)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
    CTriangleTool *tool = createTriangleTool();
...
TEST(CTriangleToolToolCreatItemUpdate, WrongBusinessItemType_NoCrash)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CTriangleToolToolCreatItemUpdate, NoModifiers_FreeFormRect)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
    ...
    CGraphicsTriangleItem *item = new CGraphicsTriangleItem(QRectF(0, 0, 1, 1));
    scene->addItem(item);
...
TEST(CTriangleToolToolCreatItemUpdate, ShiftOnly_AbsLengthGeHPositive)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CTriangleToolToolCreatItemUpdate, ShiftOnly_AbsLengthGeHNegative)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CTriangleToolToolCreatItemUpdate, ShiftOnly_AbsLengthLtWPositive)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CTriangleToolToolCreatItemUpdate, ShiftOnly_AbsLengthLtWNegative)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CTriangleToolToolCreatItemUpdate, AltOnly_CenteredRect)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
...
TEST(CTriangleToolToolCreatItemUpdate, ShiftAlt_CenteredSquare)
{
    // Arrange
    PageScene *scene = getTestScene();
    ASSERT_NE(scene, nullptr);
